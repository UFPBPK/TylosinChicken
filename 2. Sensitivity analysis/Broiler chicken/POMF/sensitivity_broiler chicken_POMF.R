## Scenario:Broiler chickens following POMF 50mg/kg for 10 doses wihthin 5 days
...
setwd("C:/Users/zhichengzhang/Desktop/Tyloasin_08_18/Figures/Figure 7_Sensitivity analysis/Broiler chicken/POMF")
...
heatmap2 <- ggplot(ttt_long, aes(x = variable, y = X, fill = value)) + 
  geom_tile() + 
  ...
  labs(title = "(A) Normalized Sensitivity Coefficients for broiler chicken (POMF)", x = "Target tissues", y = "Parameters") +
  theme_minimal() +
